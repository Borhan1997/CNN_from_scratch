    ...
    return (
        <div className="w-full text-center">
            <svg 
                ...
                className={`mx-auto block rounded border border-stone-200 ${internal ? "w-full max-w-32" : spectogram ? "w-full object-contain" : "w-full max-w-[500px] max-h-[300px] object-contain"}`}
            >
