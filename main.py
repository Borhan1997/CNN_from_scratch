...
app = modal.App("CNN_from_scratch_inference")
...
class AudioClassifier:
    ...
    def load_model(self):
        ...
        checkpoint = torch.load('/models/best_model.pth', map_location=self.device, weights_only=True)
...
def main():
    audio_data, sample_rate = sf.read("30.wav")
